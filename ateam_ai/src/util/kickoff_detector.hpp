...
// All this class is for is latching the position of the ball when we go from kickoff prep to normal start so we know gives a different state during our kickoff vs theirs
...
// I kinda thought against it because I didnt know anyones opinions on adding new states to the game command thing
...
public:
  ...
  void update(World world)
  {
    ...
    // was told no timeout was needed so all of this was needlessly complicated
